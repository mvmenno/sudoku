...
var SudokuGame = /*#__PURE__*/function () {
  function SudokuGame() {
    _classCallCheck(this, SudokuGame);

    _defineProperty(this, "board", void 0);

    _defineProperty(this, "solvedBoard", void 0);

    _defineProperty(this, "boardEl", void 0);

    _defineProperty(this, "used", []);

    _defineProperty(this, "shiftRows", []);

    _defineProperty(this, "validBoard", false);

    _defineProperty(this, "ts", 0);
  ...
  _createClass(SudokuGame, [{
    ...
    key: "generatePresetValues",
    value: function generatePresetValues() {
      var r1 = 3;
      var r2 = 1;
      ...
      for (var i = 0; i < shiftRounds; i++) {
        ...
        var r2 = Math.floor(Math.random() * (8 - 4 + 1) + 4); //var r2 = Math.floor(Math.random() * 8) + 1; 
      ...
      this.validBoard = true; //var newArr = this.insertAndShift(this.board,1,5);
      //this.board = newArr;
    }
  }, {
    key: "insertAndShift",
    value: function insertAndShift(arr, from, to) {
    ...
    key: "solverCheck",
    value: function solverCheck(y, x) {
      var valid = true;
    ...
    key: "updateValue",
    value: function updateValue(y, x) {
      var valid = true;
